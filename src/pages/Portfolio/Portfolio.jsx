							...
							<div className="list_block">
								...
								<div className="list_idid">
									<div className="idid">
										...
										<p className="details">
											41기 ‘비타민상’ 수상 / 부트캠프 홍보용 개인인터뷰 선발
										</p>
									</div>
									<div className="skills">
										<span className="skills_txt">학습언어</span>
										<span className="skills_list">
											HTML / CSS / JavaScript / React / Git / GitHub
											<span style={{ display: 'inline-block', marginTop: 3 }}>
												Sass / Styled Component / Redux
											</span>
										</span>
									</div>
								</div>
							...
							<div className="list_block">
								...
								<div className="list_idid">
									<div className="idid">
										...
										<p className="details">웹/앱 기획, 디자인, 개발 (내용 더 추가하기)</p>
									</div>
									<div className="skills">
										<span className="skills_txt">학습언어</span>
										<span className="skills_list">
										...
										<div className="feature_box">
											...
											<div className="feature_details">
												...
												<div className="troubleShooting_box">
													...
													<div className="content">
														<p className="content_title">
															• 로그아웃을 한 뒤에도, 로그인 정보가 로그인 input 창에 계속 남아있는
															문제
														</p>
														<p className="content_desc">
															input 의 value 값을 관리하고 있는 state 가 recoil로 관리되고 있었는데,
															로그아웃 시에는 세션스토리지에 있는 토큰만 삭제(remove) 해주도록 하는
															로직만 있었기에 리렌더링이 되지 않았다. 그로 인해 inputvalue 값이
															초기화 되지 않아 회원 정보가 그대로 남아있었던 문제가 있었다.
														</p>
														<p className="content_solu">
											...
											<div className="feature_details">
												...
												<div className="troubleShooting_box">
													...
													<div className="content">
														<p className="content_title">
															• 서비스 내에서 회원정보가 필요할 때 마다 백엔드에게 토큰을 통신해야
															하는 번거로움
														</p>
														<p className="content_desc">
															회원유무를 확인해야 하는 사이트마다, header 에 token을 담아 보내
															회원정보를 받아와야 했다. 그로 인해 중복되는 코드가 많아졌고, 매번
															통신을 해야하는 번거로움이 생겼다.
														</p>
														<p className="content_solu">
															<span style={{ fontWeight: 700 }}>해결 :</span> 로그인 성공 시,
															어디에서나 토큰을 확인하여 회원 flow가 원활히 진행될 수 있도록, 해당
															토큰을 decoding 하여 recoilState로 관리하여 필요할 때마다 state로
															가져와 활용
														</p>
													</div>
												</div>
										...
										<div className="feature_box">
											...
											<div className="feature_details">
												...
												<ul className="details_listbox">
													...
													<li className="details_list">
														• 사용자에게는 보이지 않는 target을 생성하여, viewport가 감지하면
														콜백함수를 실행시켜, 다음에 보여야 할 데이터를 받아와 렌더링
													</li>
													<li className="details_list">
											...
											<div className="feature_details">
												...
												<ul className="details_listbox">
													...
													<li className="details_list">
														• 프로덕트가 영화인만큼 스포/미스포에 예민할 사용자를 위해 toggle on/off
														로 스포의 포함유무를 결정할 수 있도록 구현
													</li>
													<li className="details_list">
												...
												<div className="troubleShooting_box">
													...
													<div className="content">
														...
														<p className="content_desc">
															포스트의 작성일과 현재 날짜의 오차일을 구하는 로직이, 몇몇
															컴포넌트에서 반복되고 그 코드가 짧지 않아서, 많은 메모리가 낭비되어
															보였다.
														</p>
														<p className="content_solu">
															<span style={{ fontWeight: 700 }}>해결 :</span> 필요한 값을 인자로
															받는 함수로 따로 분리하여 필요한 곳에 import하여 사용하였다. 10줄 넘는
															코드를 한줄로 줄일 수 있었다.
														</p>
													</div>
												</div>
												...
												<ul className="details_listbox" style={{ marginTop: 18 }}>
													...
													<li className="details_list">
														• My blog 의 탭을 클릭 시, 회원 본인이 쓴 블로그 데이터만 모아볼 수
														있도록 구현
													</li>
													<li className="details_list">
														• 백엔드에게 POST로 header에 토큰을 보내 회원 본인인지 확인 및 데이터
														통신
													</li>
													<li className="details_list">
														• My blog 데이터만 렌더링 될 수 있도록, state로 상태값 관리하여
														삼항연산자로 컴포넌트 분기처리
													</li>
												</ul>
											</div>
										...
										<div className="feature_box">
											...
											<div className="feature_details">
												<ul className="details_listbox">
													...
													<li className="details_list">
														• 메인페이지에서는 영화를 검색하여, dropdown으로 검색결과가 나오면,
														클릭하여 해당 영화 예고편 페이지로 이동
													</li>
													<li className="details_list">
